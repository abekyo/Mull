...
final class LLMClient {
    ...
    private func callLocalOpenAI(system: String?, prompt: String, options: Options,
        ...
        return try await chatCompletions(
            ...
            connectHint: String(localized: "No local server at \(trimmedBase). Start LM Studio (Local Server) or your runtime, then load a model."),
            onToken: onToken)
    }
    ...
    private func callOpenAI(system: String?, prompt: String, options: Options,
        ...
        return try await chatCompletions(
            ...
            connectHint: String(localized: "No internet connection."),
